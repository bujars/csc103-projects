 ...
 * YOUR OWN WORK**.
 * References:
 * Project webpage to get all of the code above int main
 */
...
using std::string; //not sure what this actually does  2/5/18 //Update: I believe it is to allow it to use the string variable, still unsure.
